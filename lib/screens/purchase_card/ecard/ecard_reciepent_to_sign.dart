...
import '../../../card_editor/display_image.dart';
...
import '../../sign_card/delivery_option.dart';

class ECardReciepentToSign extends StatefulWidget {
  const ECardReciepentToSign({Key? key}) : super(key: key);

  @override
  _ECardReciepentToSignState createState() => _ECardReciepentToSignState();
}

class _ECardReciepentToSignState extends State<ECardReciepentToSign> {
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: () {
                          ...
                          if(temp.isEmpty && !pressAttention){
                            ...
                            Get.to(()=>ImageDisplay(textPropertiesBloc.imageFile));
