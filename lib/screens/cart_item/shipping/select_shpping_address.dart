...
class SelectShippingAddress extends StatefulWidget {
  const SelectShippingAddress({Key? key}) : super(key: key);

  @override
  _SelectShippingAddressState createState() => _SelectShippingAddressState();
}
              ...
              child: GestureDetector(
                onTap: () async {
                  if (_addressModel.address!.isNotEmpty) {
                    ...
                    StaticData.addressID = addressId;
                    ...
                    if (shippingBloc.getShippingRatesModel.statusCode == 200) {
                      ...
                      CommonModel shippingModel =
                          shippingBloc.getShippingRatesModel;
                      Navigator.of(context).pop();
