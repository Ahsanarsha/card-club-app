...
class RemoveReminderRecipient extends StatefulWidget {
  const RemoveReminderRecipient({Key? key}) : super(key: key);

  @override
  _RemoveReminderRecipientState createState() =>
      _RemoveReminderRecipientState();
}

class _RemoveReminderRecipientState extends State<RemoveReminderRecipient> {
  var _searchTEC = TextEditingController();
  GetReminderModel model = getReminderBloc.getReminderModel;

  List<Contacts> contactData = [];
  List<String> temp = [];
                        ...
                        children: [
                          ...
                          Container(
                              ...
                              child: ElevatedButton(
                                ...
                                onPressed: () {
                                  int reminderId =
                                      model.reminders![reminderIndex].id!;
                                  removeContactsInReminder(context, reminderId);
                                },
                                child: Text(
                                  "Done",
                                  style: TextStyle(color: Colors.white),
                    ...
                    ? ListView.builder(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          return _searchTEC.text.isEmpty
                              ...
                              : _myContactsWidget(_filteredList[index], index);
                        })
                    : Container(
                        child: Center(
  ...
  Widget _myContactsWidget(Contacts contacts, int index) {
    String finalUrl = '';
    try {
  ...
  removeContactsInReminder(BuildContext context, int reminderId) async {
