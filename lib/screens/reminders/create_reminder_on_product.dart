...
import 'package:card_club/screens/home_gift/gift_product_page.dart';
...
class CreateReminderOnProduct extends StatefulWidget {
  const CreateReminderOnProduct({Key? key}) : super(key: key);

  @override
  _CreateReminderOnProductState createState() =>
      _CreateReminderOnProductState();
}

class _CreateReminderOnProductState extends State<CreateReminderOnProduct> {
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Create New Reminder On Product',
                      ...
                      child: FlatButton(
                          onPressed: () async {
                            ...
                            if (title.isEmpty) {
                              ...
                              saveReminder(
                                  context, list[0].id!, title, dateTime);
                            }
                          },
                          shape: RoundedRectangleBorder(
  ...
  saveReminder(
    ...
    CommonModel model = reminderBloc.createReminderModel;
    Navigator.of(context).pop();
