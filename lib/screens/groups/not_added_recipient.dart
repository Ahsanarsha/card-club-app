...
import 'package:card_club/screens/groups/bloc/group_bloc.dart';
...
class NotAddedRecipient extends StatefulWidget {
  const NotAddedRecipient({Key? key}) : super(key: key);

  @override
  _NotAddedRecipientState createState() => _NotAddedRecipientState();
}

class _NotAddedRecipientState extends State<NotAddedRecipient> {
                        ...
                        children: [
                          ...
                          Container(
                              ...
                              child: ElevatedButton(
                                ...
                                onPressed: () {
                                  addContactsInGroup(context,groupId);
                                },
                                child: Text(
                                  "Done",
                                  style: TextStyle(color: Colors.white),
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 10),
                    temp.isNotEmpty
                        ? Text('You Have selected (${temp.length})')
                        : Container(),
                  ],
                ),
              ),
  ...
  addContactsInGroup(BuildContext context,int groupId) async {
    showDialog(
